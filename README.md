...
#### `npm run android`  
Runs on an android device. Use Genymotion and run a virtual device with ELO specs to run this in simulator. Use remote debugging in the simulator (ctrl + M  >> Remote JS Debugging)
